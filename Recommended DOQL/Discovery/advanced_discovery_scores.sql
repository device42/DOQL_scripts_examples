...
Where vsd.platform <> 'vmware' 
  and ds.updated > current_date - 14 
  and (js.jobscore_pk in (Select max(jobscore_pk) From view_jobscore_v1 jk Group by jk.vserverdiscovery_fk))
