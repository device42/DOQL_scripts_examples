...
Select  Distinct vnd.name "Vendor", svc.displayname "Service", svc.pretty_name "Pretty Name", sw.name "Software", siu.version "Version", siu.alias_name "Alias", dev.name "Host", sid.cmd_path "CMD Path", si.first_detected "First Detected", si.last_updated "Last Updated"
