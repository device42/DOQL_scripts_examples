...
- Purpose: A parameterized query used to fetch extensive data on a specific IP or Device.
*/
...
where ip.ip_address = {ip_address} OR lower(d.name) LIKE CONCAT('%',{ip_address},'%')
